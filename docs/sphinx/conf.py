...
project = 'sdss_install'
copyright = '{0}, {1}'.format('2018', 'N Benjamin Murphy')
...
htmlhelp_basename = '{0}pdoc'.format('sdss_install')
...
man_pages = [
    (master_doc, 'sdss_install', u'{0} Documentation'.format(project),
     [author], 1)
]
