...
class Tags:
    ...
    def set_tags(self):
        '''Concatenate a list of dictionaries from all GraphQL pages containing tag information.'''
        self.tags = list()
        self.set_store()
    ...
    def set_tag_edges_and_page_info(self, data=None):
        '''From the GraphQL query payload data, set a pagination information dictionary and a list of dictionaries containing tag fields.'''
        self.tag_edges = None
        self.page_info = None
    ...
    def set_datetime_list(self):
        '''Set a datetime list from the list of dictionaries containing tag information.'''
    ...
    def process_datetime_list(self):
        '''Replace the datetime list with only the datetime, extracted from the two datetime formats.'''
